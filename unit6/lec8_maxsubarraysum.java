...
public class lec8_maxsubarraysum {  //n(n+1)/2
    ...
    public static void subarray(int arr[],int arr2[]){
        ...
        for(int i=0;i<arr.length;i++){
            ...
            for(int j=i;j<arr.length;j++){
                ...
                //to reduce time and space complexitty instead of storing sum in array we can compare it sum with and update according to condition
                if(sum>TEMPI){
                    TEMPI=sum;
                }
                System.out.println();
